...
# Partitioner parameters
	...
	tf.app.flags.DEFINE_float("partitioner_learning_factor", 3, "Should be a number greater than 0. Usually the partitioner has an higher learning rate than the others. This factor is used to change the initial learning rate of the partitioner only.") # default is 2.0
...
# Actor-Critic parameters
	...
	tf.app.flags.DEFINE_float("gamma", 0.95, "discount factor for rewards") # default is 0.95, for openAI is 0.99
# Generalized Advantage Estimation	
	...
	tf.app.flags.DEFINE_float("lambd", 0.75, "generalized advantage estimator decay parameter") # default is 0.95
# Log
