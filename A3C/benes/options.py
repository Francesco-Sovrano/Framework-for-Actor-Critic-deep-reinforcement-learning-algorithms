...
def build(option_type):
	...
	tf.app.flags.DEFINE_string("state_generator", "TripleLayer_1_StateGenerator", "the state generator must be a classname from rogueinabox/states.py")
	tf.app.flags.DEFINE_string("reward_generator", "StairSeeker_24_RewardGenerator", "the reward generator must be a classname from rogueinabox/rewards.py")
